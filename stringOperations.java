...
class stringOperations{
    ...
    //This Method Is Used To Count Number Of Words In String
    ...
    public static String replaceCharacter(String inputString, char oldCharacter, char newCharacter){
        ...
        for(int i = 0; i < inputString.length(); i++){
            if(inputString.charAt(i) == oldCharacter){
                ansString += newCharacter;
            }
            else{
    ...
    public static void main(String[] args){
        ...
        //Calling For Operation 3
            ...
            inputString = replaceCharacter(inputString, oldChar, newChar);
